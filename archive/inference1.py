...
def inference(model, 
    ...
    # Ensure compatibility with both single-GPU and DataParallel models
    training_status = model.module.get_training_status() if isinstance(model, nn.DataParallel) else model.get_training_status()
