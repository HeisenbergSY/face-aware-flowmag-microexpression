    ...
    for subfolder in os.listdir(video_dir):
        ...
        for episode_folder in os.listdir(subfolder_path):
            ...
            for frame_file in sorted(os.listdir(episode_path)):
                ...
                # Check for valid frame files inside the episode folder
            ...
            print(f"Saved LBP-TOP features for {episode_folder} in {feature_file}")
            ...
            print(f"Saved histogram image for {episode_folder} in {histogram_image_path}")
